...
pub struct CreateTaskSuiteWithTraceRequestTraceTask {
    ...
    pub config: Option<CreateTaskSuiteWithTraceRequestTraceTaskConfig>,
...
impl CreateTaskSuiteWithTraceRequestTraceTask {
    pub fn builder() -> CreateTaskSuiteWithTraceRequestTraceTaskBuilder {
        <CreateTaskSuiteWithTraceRequestTraceTaskBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateTaskSuiteWithTraceRequestTraceTaskBuilder {
    config: Option<CreateTaskSuiteWithTraceRequestTraceTaskConfig>,
...
impl CreateTaskSuiteWithTraceRequestTraceTaskBuilder {
    pub fn config(mut self, value: CreateTaskSuiteWithTraceRequestTraceTaskConfig) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateTaskSuiteWithTraceRequestTraceTask`].
    pub fn build(self) -> Result<CreateTaskSuiteWithTraceRequestTraceTask, BuildError> {
        Ok(CreateTaskSuiteWithTraceRequestTraceTask {
            config: self.config,
