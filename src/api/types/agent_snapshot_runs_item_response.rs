...
pub struct AgentSnapshotRunsItemResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub usage: Option<AgentSnapshotRunsItemResponseUsage>,
}

impl AgentSnapshotRunsItemResponse {
    pub fn builder() -> AgentSnapshotRunsItemResponseBuilder {
        <AgentSnapshotRunsItemResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AgentSnapshotRunsItemResponseBuilder {
    ...
    usage: Option<AgentSnapshotRunsItemResponseUsage>,
}

impl AgentSnapshotRunsItemResponseBuilder {
    ...
    pub fn usage(mut self, value: AgentSnapshotRunsItemResponseUsage) -> Self {
        self.usage = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`AgentSnapshotRunsItemResponse`].
    pub fn build(self) -> Result<AgentSnapshotRunsItemResponse, BuildError> {
        Ok(AgentSnapshotRunsItemResponse {
