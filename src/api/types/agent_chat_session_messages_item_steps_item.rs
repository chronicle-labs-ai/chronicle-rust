...
pub struct AgentChatSessionMessagesItemStepsItem {
...
impl AgentChatSessionMessagesItemStepsItem {
    pub fn builder() -> AgentChatSessionMessagesItemStepsItemBuilder {
        <AgentChatSessionMessagesItemStepsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AgentChatSessionMessagesItemStepsItemBuilder {
...
impl AgentChatSessionMessagesItemStepsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`AgentChatSessionMessagesItemStepsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`event_type`](AgentChatSessionMessagesItemStepsItemBuilder::event_type)
    /// - [`source`](AgentChatSessionMessagesItemStepsItemBuilder::source)
    /// - [`step_id`](AgentChatSessionMessagesItemStepsItemBuilder::step_id)
    /// - [`text`](AgentChatSessionMessagesItemStepsItemBuilder::text)
    /// - [`tool_name`](AgentChatSessionMessagesItemStepsItemBuilder::tool_name)
    pub fn build(self) -> Result<AgentChatSessionMessagesItemStepsItem, BuildError> {
        Ok(AgentChatSessionMessagesItemStepsItem {
