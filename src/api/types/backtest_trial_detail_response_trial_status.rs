...
pub enum BacktestTrialDetailResponseTrialStatus {
    Pending,
    Setup,
    Running,
    Verifying,
...
impl Serialize for BacktestTrialDetailResponseTrialStatus {
...
impl<'de> Deserialize<'de> for BacktestTrialDetailResponseTrialStatus {
...
impl fmt::Display for BacktestTrialDetailResponseTrialStatus {
