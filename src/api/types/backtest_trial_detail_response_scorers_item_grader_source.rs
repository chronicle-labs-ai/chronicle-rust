...
pub enum BacktestTrialDetailResponseScorersItemGraderSource {
    Proposed,
    Library,
    Custom,
    Dataset,
...
impl Serialize for BacktestTrialDetailResponseScorersItemGraderSource {
...
impl<'de> Deserialize<'de> for BacktestTrialDetailResponseScorersItemGraderSource {
...
impl fmt::Display for BacktestTrialDetailResponseScorersItemGraderSource {
