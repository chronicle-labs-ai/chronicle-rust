...
pub struct CreateAgentChatSessionResponseSessionMessagesItemStepsItem {
...
impl CreateAgentChatSessionResponseSessionMessagesItemStepsItem {
    pub fn builder() -> CreateAgentChatSessionResponseSessionMessagesItemStepsItemBuilder {
        <CreateAgentChatSessionResponseSessionMessagesItemStepsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateAgentChatSessionResponseSessionMessagesItemStepsItemBuilder {
...
impl CreateAgentChatSessionResponseSessionMessagesItemStepsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateAgentChatSessionResponseSessionMessagesItemStepsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`event_type`](CreateAgentChatSessionResponseSessionMessagesItemStepsItemBuilder::event_type)
    /// - [`source`](CreateAgentChatSessionResponseSessionMessagesItemStepsItemBuilder::source)
    /// - [`step_id`](CreateAgentChatSessionResponseSessionMessagesItemStepsItemBuilder::step_id)
    /// - [`text`](CreateAgentChatSessionResponseSessionMessagesItemStepsItemBuilder::text)
    /// - [`tool_name`](CreateAgentChatSessionResponseSessionMessagesItemStepsItemBuilder::tool_name)
    pub fn build(
        self,
    ) -> Result<CreateAgentChatSessionResponseSessionMessagesItemStepsItem, BuildError> {
        Ok(CreateAgentChatSessionResponseSessionMessagesItemStepsItem {
