...
pub enum BacktestJobDetailResponseRunStatus {
    Running,
    Done,
    Paused,
    Scheduled,
...
impl Serialize for BacktestJobDetailResponseRunStatus {
...
impl<'de> Deserialize<'de> for BacktestJobDetailResponseRunStatus {
...
impl fmt::Display for BacktestJobDetailResponseRunStatus {
