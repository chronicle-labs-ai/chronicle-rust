...
pub enum CreateTaskSuitePayloadPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for CreateTaskSuitePayloadPurpose {
...
impl<'de> Deserialize<'de> for CreateTaskSuitePayloadPurpose {
...
impl fmt::Display for CreateTaskSuitePayloadPurpose {
