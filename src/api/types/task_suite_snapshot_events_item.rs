...
pub struct TaskSuiteSnapshotEventsItem {
...
impl TaskSuiteSnapshotEventsItem {
    pub fn builder() -> TaskSuiteSnapshotEventsItemBuilder {
        <TaskSuiteSnapshotEventsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TaskSuiteSnapshotEventsItemBuilder {
    actor: Option<String>,
    color: Option<String>,
...
impl TaskSuiteSnapshotEventsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`TaskSuiteSnapshotEventsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](TaskSuiteSnapshotEventsItemBuilder::id)
    /// - [`occurred_at`](TaskSuiteSnapshotEventsItemBuilder::occurred_at)
    /// - [`source`](TaskSuiteSnapshotEventsItemBuilder::source)
    /// - [`r#type`](TaskSuiteSnapshotEventsItemBuilder::r#type)
    pub fn build(self) -> Result<TaskSuiteSnapshotEventsItem, BuildError> {
        Ok(TaskSuiteSnapshotEventsItem {
            actor: self.actor,
            color: self.color,
