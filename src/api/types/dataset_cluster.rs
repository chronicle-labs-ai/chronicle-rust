...
impl DatasetCluster {
    pub fn builder() -> DatasetClusterBuilder {
        <DatasetClusterBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DatasetClusterBuilder {
    color: Option<String>,
...
impl DatasetClusterBuilder {
    ...
    /// Consumes the builder and constructs a [`DatasetCluster`].
    /// This method will fail if any of the following fields are not set:
    /// - [`color`](DatasetClusterBuilder::color)
    /// - [`id`](DatasetClusterBuilder::id)
    /// - [`label`](DatasetClusterBuilder::label)
    /// - [`trace_ids`](DatasetClusterBuilder::trace_ids)
    pub fn build(self) -> Result<DatasetCluster, BuildError> {
        Ok(DatasetCluster {
            color: self
                .color
