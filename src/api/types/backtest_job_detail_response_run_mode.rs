...
pub enum BacktestJobDetailResponseRunMode {
    Replay,
    Compare,
    Regression,
    Suite,
...
impl Serialize for BacktestJobDetailResponseRunMode {
...
impl<'de> Deserialize<'de> for BacktestJobDetailResponseRunMode {
...
impl fmt::Display for BacktestJobDetailResponseRunMode {
