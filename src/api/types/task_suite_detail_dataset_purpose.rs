...
pub enum TaskSuiteDetailDatasetPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for TaskSuiteDetailDatasetPurpose {
...
impl<'de> Deserialize<'de> for TaskSuiteDetailDatasetPurpose {
...
impl fmt::Display for TaskSuiteDetailDatasetPurpose {
