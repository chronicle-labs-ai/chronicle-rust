...
pub struct TaskVerifiersItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub weight: Option<TaskVerifiersItemWeight>,
}

impl TaskVerifiersItem {
    pub fn builder() -> TaskVerifiersItemBuilder {
        <TaskVerifiersItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TaskVerifiersItemBuilder {
    pass_threshold: Option<f64>,
    scorer_id: Option<String>,
    weight: Option<TaskVerifiersItemWeight>,
}

impl TaskVerifiersItemBuilder {
    ...
    pub fn weight(mut self, value: TaskVerifiersItemWeight) -> Self {
        self.weight = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`TaskVerifiersItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`scorer_id`](TaskVerifiersItemBuilder::scorer_id)
    pub fn build(self) -> Result<TaskVerifiersItem, BuildError> {
        Ok(TaskVerifiersItem {
