...
pub enum AddTaskFromTraceRequestSplit {
    Train,
    Validation,
    Test,
...
impl Serialize for AddTaskFromTraceRequestSplit {
...
impl<'de> Deserialize<'de> for AddTaskFromTraceRequestSplit {
...
impl fmt::Display for AddTaskFromTraceRequestSplit {
