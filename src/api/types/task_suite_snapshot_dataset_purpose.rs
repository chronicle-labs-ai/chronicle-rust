...
pub enum TaskSuiteSnapshotDatasetPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for TaskSuiteSnapshotDatasetPurpose {
...
impl<'de> Deserialize<'de> for TaskSuiteSnapshotDatasetPurpose {
...
impl fmt::Display for TaskSuiteSnapshotDatasetPurpose {
