...
pub struct AgentSnapshotVersionsItem {
    pub artifact: AgentSnapshotVersionsItemArtifact,
    ...
    #[serde(default)]
    pub run_count: i64,
    pub status: AgentSnapshotVersionsItemStatus,
...
impl AgentSnapshotVersionsItem {
    pub fn builder() -> AgentSnapshotVersionsItemBuilder {
        <AgentSnapshotVersionsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AgentSnapshotVersionsItemBuilder {
    artifact: Option<AgentSnapshotVersionsItemArtifact>,
    ...
    status: Option<AgentSnapshotVersionsItemStatus>,
    success_rate: Option<f64>,
    total_tokens: Option<i64>,
}

impl AgentSnapshotVersionsItemBuilder {
    pub fn artifact(mut self, value: AgentSnapshotVersionsItemArtifact) -> Self {
    ...
    pub fn status(mut self, value: AgentSnapshotVersionsItemStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`AgentSnapshotVersionsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`artifact`](AgentSnapshotVersionsItemBuilder::artifact)
    /// - [`resolved_model_ids`](AgentSnapshotVersionsItemBuilder::resolved_model_ids)
    /// - [`run_count`](AgentSnapshotVersionsItemBuilder::run_count)
    /// - [`status`](AgentSnapshotVersionsItemBuilder::status)
    /// - [`success_rate`](AgentSnapshotVersionsItemBuilder::success_rate)
    pub fn build(self) -> Result<AgentSnapshotVersionsItem, BuildError> {
        Ok(AgentSnapshotVersionsItem {
            artifact: self
                .artifact
