...
pub enum TaskPageItemsItemSubjectKind {
    Trace,
    Event,
    Task,
...
impl Serialize for TaskPageItemsItemSubjectKind {
...
impl<'de> Deserialize<'de> for TaskPageItemsItemSubjectKind {
...
impl fmt::Display for TaskPageItemsItemSubjectKind {
