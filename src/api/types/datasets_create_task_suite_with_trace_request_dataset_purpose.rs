...
pub enum CreateTaskSuiteWithTraceRequestDatasetPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for CreateTaskSuiteWithTraceRequestDatasetPurpose {
...
impl<'de> Deserialize<'de> for CreateTaskSuiteWithTraceRequestDatasetPurpose {
...
impl fmt::Display for CreateTaskSuiteWithTraceRequestDatasetPurpose {
