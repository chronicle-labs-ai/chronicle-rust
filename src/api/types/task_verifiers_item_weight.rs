...
pub enum TaskVerifiersItemWeight {
    Low,
    Med,
    High,
...
impl Serialize for TaskVerifiersItemWeight {
...
impl<'de> Deserialize<'de> for TaskVerifiersItemWeight {
...
impl fmt::Display for TaskVerifiersItemWeight {
