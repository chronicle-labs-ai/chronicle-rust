...
pub enum BacktestJobDetailResponseJobStatus {
    Pending,
    Running,
    Succeeded,
    Failed,
...
impl Serialize for BacktestJobDetailResponseJobStatus {
...
impl<'de> Deserialize<'de> for BacktestJobDetailResponseJobStatus {
...
impl fmt::Display for BacktestJobDetailResponseJobStatus {
