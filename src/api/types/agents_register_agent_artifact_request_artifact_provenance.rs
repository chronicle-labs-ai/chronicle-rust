...
pub struct RegisterAgentArtifactRequestArtifactProvenance {
...
impl RegisterAgentArtifactRequestArtifactProvenance {
    pub fn builder() -> RegisterAgentArtifactRequestArtifactProvenanceBuilder {
        <RegisterAgentArtifactRequestArtifactProvenanceBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RegisterAgentArtifactRequestArtifactProvenanceBuilder {
...
impl RegisterAgentArtifactRequestArtifactProvenanceBuilder {
    ...
    /// Consumes the builder and constructs a [`RegisterAgentArtifactRequestArtifactProvenance`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](RegisterAgentArtifactRequestArtifactProvenanceBuilder::created_at)
    pub fn build(self) -> Result<RegisterAgentArtifactRequestArtifactProvenance, BuildError> {
        Ok(RegisterAgentArtifactRequestArtifactProvenance {
