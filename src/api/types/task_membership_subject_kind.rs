...
pub enum TaskMembershipSubjectKind {
    Trace,
    Event,
    Task,
...
impl Serialize for TaskMembershipSubjectKind {
...
impl<'de> Deserialize<'de> for TaskMembershipSubjectKind {
...
impl fmt::Display for TaskMembershipSubjectKind {
