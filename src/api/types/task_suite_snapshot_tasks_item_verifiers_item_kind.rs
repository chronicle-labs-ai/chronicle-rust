...
pub enum TaskSuiteSnapshotTasksItemVerifiersItemKind {
    Rubric,
    Classifier,
    Metric,
    Embedding,
...
impl Serialize for TaskSuiteSnapshotTasksItemVerifiersItemKind {
...
impl<'de> Deserialize<'de> for TaskSuiteSnapshotTasksItemVerifiersItemKind {
...
impl fmt::Display for TaskSuiteSnapshotTasksItemVerifiersItemKind {
