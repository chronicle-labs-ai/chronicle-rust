...
pub struct TaskSuiteDetailDataset {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub purpose: Option<TaskSuiteDetailDatasetPurpose>,
...
impl TaskSuiteDetailDataset {
    pub fn builder() -> TaskSuiteDetailDatasetBuilder {
        <TaskSuiteDetailDatasetBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TaskSuiteDetailDatasetBuilder {
    ...
    id: Option<String>,
    name: Option<String>,
    purpose: Option<TaskSuiteDetailDatasetPurpose>,
    tags: Option<Vec<String>>,
    trace_count: Option<i64>,
    updated_at: Option<DateTime<FixedOffset>>,
}

impl TaskSuiteDetailDatasetBuilder {
    ...
    pub fn purpose(mut self, value: TaskSuiteDetailDatasetPurpose) -> Self {
    ...
    /// Consumes the builder and constructs a [`TaskSuiteDetailDataset`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](TaskSuiteDetailDatasetBuilder::id)
    /// - [`name`](TaskSuiteDetailDatasetBuilder::name)
    /// - [`trace_count`](TaskSuiteDetailDatasetBuilder::trace_count)
    pub fn build(self) -> Result<TaskSuiteDetailDataset, BuildError> {
        Ok(TaskSuiteDetailDataset {
