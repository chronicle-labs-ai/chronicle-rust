...
pub enum TaskSuiteSnapshotTasksItemSubjectKind {
    Trace,
    Event,
    Task,
...
impl Serialize for TaskSuiteSnapshotTasksItemSubjectKind {
...
impl<'de> Deserialize<'de> for TaskSuiteSnapshotTasksItemSubjectKind {
...
impl fmt::Display for TaskSuiteSnapshotTasksItemSubjectKind {
