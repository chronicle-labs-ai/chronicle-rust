...
pub enum TaskSuitePageItemsItemPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for TaskSuitePageItemsItemPurpose {
...
impl<'de> Deserialize<'de> for TaskSuitePageItemsItemPurpose {
...
impl fmt::Display for TaskSuitePageItemsItemPurpose {
