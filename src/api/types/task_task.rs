...
pub struct TaskTask {
    ...
    pub config: Option<TaskTaskConfig>,
...
impl TaskTask {
    pub fn builder() -> TaskTaskBuilder {
        <TaskTaskBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TaskTaskBuilder {
    config: Option<TaskTaskConfig>,
...
impl TaskTaskBuilder {
    pub fn config(mut self, value: TaskTaskConfig) -> Self {
    ...
    /// Consumes the builder and constructs a [`TaskTask`].
    pub fn build(self) -> Result<TaskTask, BuildError> {
        Ok(TaskTask {
            config: self.config,
