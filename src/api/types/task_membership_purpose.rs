...
pub enum TaskMembershipPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for TaskMembershipPurpose {
...
impl<'de> Deserialize<'de> for TaskMembershipPurpose {
...
impl fmt::Display for TaskMembershipPurpose {
