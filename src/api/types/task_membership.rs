...
pub struct TaskMembership {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub purpose: Option<TaskMembershipPurpose>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub split: Option<TaskMembershipSplit>,
    ...
    pub subject_kind: TaskMembershipSubjectKind,
...
impl TaskMembership {
    pub fn builder() -> TaskMembershipBuilder {
        <TaskMembershipBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TaskMembershipBuilder {
    ...
    id: Option<String>,
    note: Option<String>,
    purpose: Option<TaskMembershipPurpose>,
    refresh_available: Option<bool>,
    revision: Option<i64>,
    split: Option<TaskMembershipSplit>,
    subject_id: Option<String>,
    subject_kind: Option<TaskMembershipSubjectKind>,
    trace_id: Option<String>,
}

impl TaskMembershipBuilder {
    ...
    pub fn purpose(mut self, value: TaskMembershipPurpose) -> Self {
    ...
    pub fn split(mut self, value: TaskMembershipSplit) -> Self {
    ...
    pub fn subject_kind(mut self, value: TaskMembershipSubjectKind) -> Self {
    ...
    /// Consumes the builder and constructs a [`TaskMembership`].
    /// This method will fail if any of the following fields are not set:
    /// - [`dataset_id`](TaskMembershipBuilder::dataset_id)
    /// - [`dataset_name`](TaskMembershipBuilder::dataset_name)
    /// - [`event_count`](TaskMembershipBuilder::event_count)
    /// - [`id`](TaskMembershipBuilder::id)
    /// - [`refresh_available`](TaskMembershipBuilder::refresh_available)
    /// - [`revision`](TaskMembershipBuilder::revision)
    /// - [`subject_id`](TaskMembershipBuilder::subject_id)
    /// - [`subject_kind`](TaskMembershipBuilder::subject_kind)
    /// - [`trace_id`](TaskMembershipBuilder::trace_id)
    pub fn build(self) -> Result<TaskMembership, BuildError> {
        Ok(TaskMembership {
