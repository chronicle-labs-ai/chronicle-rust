...
pub enum TaskPageItemsItemSplit {
    Train,
    Validation,
    Test,
...
impl Serialize for TaskPageItemsItemSplit {
...
impl<'de> Deserialize<'de> for TaskPageItemsItemSplit {
...
impl fmt::Display for TaskPageItemsItemSplit {
