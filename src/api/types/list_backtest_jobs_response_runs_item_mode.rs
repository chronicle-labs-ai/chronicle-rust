...
pub enum ListBacktestJobsResponseRunsItemMode {
    Replay,
    Compare,
    Regression,
    Suite,
...
impl Serialize for ListBacktestJobsResponseRunsItemMode {
...
impl<'de> Deserialize<'de> for ListBacktestJobsResponseRunsItemMode {
...
impl fmt::Display for ListBacktestJobsResponseRunsItemMode {
