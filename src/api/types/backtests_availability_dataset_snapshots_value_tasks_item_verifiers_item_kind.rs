...
pub enum BacktestsAvailabilityDatasetSnapshotsValueTasksItemVerifiersItemKind {
    Rubric,
    Classifier,
    Metric,
    Embedding,
...
impl Serialize for BacktestsAvailabilityDatasetSnapshotsValueTasksItemVerifiersItemKind {
...
impl<'de> Deserialize<'de>
    for BacktestsAvailabilityDatasetSnapshotsValueTasksItemVerifiersItemKind
{
...
impl fmt::Display for BacktestsAvailabilityDatasetSnapshotsValueTasksItemVerifiersItemKind {
