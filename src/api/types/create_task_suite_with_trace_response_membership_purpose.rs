...
pub enum CreateTaskSuiteWithTraceResponseMembershipPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for CreateTaskSuiteWithTraceResponseMembershipPurpose {
...
impl<'de> Deserialize<'de> for CreateTaskSuiteWithTraceResponseMembershipPurpose {
...
impl fmt::Display for CreateTaskSuiteWithTraceResponseMembershipPurpose {
