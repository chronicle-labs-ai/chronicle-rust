...
pub enum BacktestsAvailabilityDatasetsItemPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for BacktestsAvailabilityDatasetsItemPurpose {
...
impl<'de> Deserialize<'de> for BacktestsAvailabilityDatasetsItemPurpose {
...
impl fmt::Display for BacktestsAvailabilityDatasetsItemPurpose {
