...
pub struct TaskEventPageItemsItem {
...
impl TaskEventPageItemsItem {
    pub fn builder() -> TaskEventPageItemsItemBuilder {
        <TaskEventPageItemsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TaskEventPageItemsItemBuilder {
    actor: Option<String>,
    color: Option<String>,
...
impl TaskEventPageItemsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`TaskEventPageItemsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](TaskEventPageItemsItemBuilder::id)
    /// - [`occurred_at`](TaskEventPageItemsItemBuilder::occurred_at)
    /// - [`source`](TaskEventPageItemsItemBuilder::source)
    /// - [`r#type`](TaskEventPageItemsItemBuilder::r#type)
    pub fn build(self) -> Result<TaskEventPageItemsItem, BuildError> {
        Ok(TaskEventPageItemsItem {
            actor: self.actor,
            color: self.color,
