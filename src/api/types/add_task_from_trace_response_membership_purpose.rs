...
pub enum AddTaskFromTraceResponseMembershipPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for AddTaskFromTraceResponseMembershipPurpose {
...
impl<'de> Deserialize<'de> for AddTaskFromTraceResponseMembershipPurpose {
...
impl fmt::Display for AddTaskFromTraceResponseMembershipPurpose {
