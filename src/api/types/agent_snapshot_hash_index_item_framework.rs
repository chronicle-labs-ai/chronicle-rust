...
pub enum AgentSnapshotHashIndexItemFramework {
    VercelAiSdk,
    OpenaiAgents,
    Langchain,
    Mastra,
...
impl Serialize for AgentSnapshotHashIndexItemFramework {
...
impl<'de> Deserialize<'de> for AgentSnapshotHashIndexItemFramework {
...
impl fmt::Display for AgentSnapshotHashIndexItemFramework {
