...
pub struct TaskSuite {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub purpose: Option<TaskSuitePurpose>,
...
impl TaskSuite {
    pub fn builder() -> TaskSuiteBuilder {
        <TaskSuiteBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TaskSuiteBuilder {
    ...
    id: Option<String>,
    name: Option<String>,
    purpose: Option<TaskSuitePurpose>,
    tags: Option<Vec<String>>,
    trace_count: Option<i64>,
    updated_at: Option<DateTime<FixedOffset>>,
}

impl TaskSuiteBuilder {
    ...
    pub fn purpose(mut self, value: TaskSuitePurpose) -> Self {
    ...
    /// Consumes the builder and constructs a [`TaskSuite`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](TaskSuiteBuilder::id)
    /// - [`name`](TaskSuiteBuilder::name)
    /// - [`trace_count`](TaskSuiteBuilder::trace_count)
    pub fn build(self) -> Result<TaskSuite, BuildError> {
        Ok(TaskSuite {
