...
pub struct CreateBacktestJobResponseRun {
    ...
    #[serde(default)]
    pub id: String,
    pub mode: CreateBacktestJobResponseRunMode,
    ...
    pub status: CreateBacktestJobResponseRunStatus,
...
impl CreateBacktestJobResponseRun {
    pub fn builder() -> CreateBacktestJobResponseRunBuilder {
        <CreateBacktestJobResponseRunBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateBacktestJobResponseRunBuilder {
    ...
    hue: Option<String>,
    id: Option<String>,
    mode: Option<CreateBacktestJobResponseRunMode>,
    name: Option<String>,
    owner: Option<String>,
    scheduled_for: Option<DateTime<FixedOffset>>,
    status: Option<CreateBacktestJobResponseRunStatus>,
    total_runs: Option<i64>,
    updated_at: Option<DateTime<FixedOffset>>,
    verdict: Option<String>,
}

impl CreateBacktestJobResponseRunBuilder {
    ...
    pub fn mode(mut self, value: CreateBacktestJobResponseRunMode) -> Self {
    ...
    pub fn status(mut self, value: CreateBacktestJobResponseRunStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateBacktestJobResponseRun`].
    /// This method will fail if any of the following fields are not set:
    /// - [`agent_ids`](CreateBacktestJobResponseRunBuilder::agent_ids)
    /// - [`dataset_label`](CreateBacktestJobResponseRunBuilder::dataset_label)
    /// - [`id`](CreateBacktestJobResponseRunBuilder::id)
    /// - [`mode`](CreateBacktestJobResponseRunBuilder::mode)
    /// - [`name`](CreateBacktestJobResponseRunBuilder::name)
    /// - [`status`](CreateBacktestJobResponseRunBuilder::status)
    /// - [`updated_at`](CreateBacktestJobResponseRunBuilder::updated_at)
    pub fn build(self) -> Result<CreateBacktestJobResponseRun, BuildError> {
        Ok(CreateBacktestJobResponseRun {
            agent_ids: self
                .agent_ids
