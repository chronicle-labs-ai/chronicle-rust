...
pub enum BacktestJobDetailResponseJobMode {
    Replay,
    Compare,
    Regression,
    Suite,
...
impl Serialize for BacktestJobDetailResponseJobMode {
...
impl<'de> Deserialize<'de> for BacktestJobDetailResponseJobMode {
...
impl fmt::Display for BacktestJobDetailResponseJobMode {
