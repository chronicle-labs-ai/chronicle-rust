...
pub enum TrialEventTrialFinishedStatus {
    Pending,
    Setup,
    Running,
    Verifying,
...
impl Serialize for TrialEventTrialFinishedStatus {
...
impl<'de> Deserialize<'de> for TrialEventTrialFinishedStatus {
...
impl fmt::Display for TrialEventTrialFinishedStatus {
