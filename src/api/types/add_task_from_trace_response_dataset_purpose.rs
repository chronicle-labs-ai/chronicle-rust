...
pub enum AddTaskFromTraceResponseDatasetPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for AddTaskFromTraceResponseDatasetPurpose {
...
impl<'de> Deserialize<'de> for AddTaskFromTraceResponseDatasetPurpose {
...
impl fmt::Display for AddTaskFromTraceResponseDatasetPurpose {
