...
pub enum AddTaskFromTraceResponseMembershipSubjectKind {
    Trace,
    Event,
    Task,
...
impl Serialize for AddTaskFromTraceResponseMembershipSubjectKind {
...
impl<'de> Deserialize<'de> for AddTaskFromTraceResponseMembershipSubjectKind {
...
impl fmt::Display for AddTaskFromTraceResponseMembershipSubjectKind {
