...
pub enum RegisterAgentArtifactRequestStatus {
    Current,
    Stable,
    Deprecated,
    Draft,
...
impl Serialize for RegisterAgentArtifactRequestStatus {
...
impl<'de> Deserialize<'de> for RegisterAgentArtifactRequestStatus {
...
impl fmt::Display for RegisterAgentArtifactRequestStatus {
