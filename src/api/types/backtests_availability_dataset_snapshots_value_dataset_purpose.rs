...
pub enum BacktestsAvailabilityDatasetSnapshotsValueDatasetPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for BacktestsAvailabilityDatasetSnapshotsValueDatasetPurpose {
...
impl<'de> Deserialize<'de> for BacktestsAvailabilityDatasetSnapshotsValueDatasetPurpose {
...
impl fmt::Display for BacktestsAvailabilityDatasetSnapshotsValueDatasetPurpose {
