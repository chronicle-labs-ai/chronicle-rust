...
pub struct DatasetSavedViewPatchState {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub filters: Option<Vec<DatasetSavedViewPatchStateFiltersItem>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sorting: Option<Vec<DatasetSavedViewPatchStateSortingItem>>,
}

impl DatasetSavedViewPatchState {
    pub fn builder() -> DatasetSavedViewPatchStateBuilder {
        <DatasetSavedViewPatchStateBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DatasetSavedViewPatchStateBuilder {
    density: Option<String>,
    display_properties: Option<Vec<String>>,
    filters: Option<Vec<DatasetSavedViewPatchStateFiltersItem>>,
    group_by: Option<String>,
    lens: Option<String>,
    ordering: Option<String>,
    search: Option<String>,
    show_empty_groups: Option<bool>,
    sorting: Option<Vec<DatasetSavedViewPatchStateSortingItem>>,
}

impl DatasetSavedViewPatchStateBuilder {
    ...
    pub fn filters(mut self, value: Vec<DatasetSavedViewPatchStateFiltersItem>) -> Self {
    ...
    pub fn sorting(mut self, value: Vec<DatasetSavedViewPatchStateSortingItem>) -> Self {
        self.sorting = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`DatasetSavedViewPatchState`].
    pub fn build(self) -> Result<DatasetSavedViewPatchState, BuildError> {
        Ok(DatasetSavedViewPatchState {
