...
pub enum TaskTaskConfigNetworkMode {
    Public,
    NoNetwork,
...
impl Serialize for TaskTaskConfigNetworkMode {
...
impl<'de> Deserialize<'de> for TaskTaskConfigNetworkMode {
...
impl fmt::Display for TaskTaskConfigNetworkMode {
