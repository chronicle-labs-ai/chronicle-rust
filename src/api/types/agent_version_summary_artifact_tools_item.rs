...
pub struct AgentVersionSummaryArtifactToolsItem {
...
impl AgentVersionSummaryArtifactToolsItem {
    pub fn builder() -> AgentVersionSummaryArtifactToolsItemBuilder {
        <AgentVersionSummaryArtifactToolsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AgentVersionSummaryArtifactToolsItemBuilder {
...
impl AgentVersionSummaryArtifactToolsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`AgentVersionSummaryArtifactToolsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](AgentVersionSummaryArtifactToolsItemBuilder::name)
    pub fn build(self) -> Result<AgentVersionSummaryArtifactToolsItem, BuildError> {
        Ok(AgentVersionSummaryArtifactToolsItem {
