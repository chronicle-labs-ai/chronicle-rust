...
pub enum AgentVersionSummaryArtifactFramework {
    VercelAiSdk,
    OpenaiAgents,
    Langchain,
    Mastra,
...
impl Serialize for AgentVersionSummaryArtifactFramework {
...
impl<'de> Deserialize<'de> for AgentVersionSummaryArtifactFramework {
...
impl fmt::Display for AgentVersionSummaryArtifactFramework {
