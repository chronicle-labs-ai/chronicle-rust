...
pub enum CreateBacktestJobResponseRunStatus {
    Running,
    Done,
    Paused,
    Scheduled,
...
impl Serialize for CreateBacktestJobResponseRunStatus {
...
impl<'de> Deserialize<'de> for CreateBacktestJobResponseRunStatus {
...
impl fmt::Display for CreateBacktestJobResponseRunStatus {
