...
pub struct TaskSuitePageItemsItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub purpose: Option<TaskSuitePageItemsItemPurpose>,
...
impl TaskSuitePageItemsItem {
    pub fn builder() -> TaskSuitePageItemsItemBuilder {
        <TaskSuitePageItemsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TaskSuitePageItemsItemBuilder {
    ...
    id: Option<String>,
    name: Option<String>,
    purpose: Option<TaskSuitePageItemsItemPurpose>,
    tags: Option<Vec<String>>,
    trace_count: Option<i64>,
    updated_at: Option<DateTime<FixedOffset>>,
}

impl TaskSuitePageItemsItemBuilder {
    ...
    pub fn purpose(mut self, value: TaskSuitePageItemsItemPurpose) -> Self {
    ...
    /// Consumes the builder and constructs a [`TaskSuitePageItemsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](TaskSuitePageItemsItemBuilder::id)
    /// - [`name`](TaskSuitePageItemsItemBuilder::name)
    /// - [`trace_count`](TaskSuitePageItemsItemBuilder::trace_count)
    pub fn build(self) -> Result<TaskSuitePageItemsItem, BuildError> {
        Ok(TaskSuitePageItemsItem {
