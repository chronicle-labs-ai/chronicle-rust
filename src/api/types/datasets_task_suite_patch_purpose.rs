...
pub enum TaskSuitePatchPurpose {
    Eval,
    Training,
    Replay,
    Review,
...
impl Serialize for TaskSuitePatchPurpose {
...
impl<'de> Deserialize<'de> for TaskSuitePatchPurpose {
...
impl fmt::Display for TaskSuitePatchPurpose {
