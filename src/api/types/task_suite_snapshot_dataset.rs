...
pub struct TaskSuiteSnapshotDataset {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub purpose: Option<TaskSuiteSnapshotDatasetPurpose>,
...
impl TaskSuiteSnapshotDataset {
    pub fn builder() -> TaskSuiteSnapshotDatasetBuilder {
        <TaskSuiteSnapshotDatasetBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TaskSuiteSnapshotDatasetBuilder {
    ...
    id: Option<String>,
    name: Option<String>,
    purpose: Option<TaskSuiteSnapshotDatasetPurpose>,
    tags: Option<Vec<String>>,
    trace_count: Option<i64>,
    updated_at: Option<DateTime<FixedOffset>>,
}

impl TaskSuiteSnapshotDatasetBuilder {
    ...
    pub fn purpose(mut self, value: TaskSuiteSnapshotDatasetPurpose) -> Self {
    ...
    /// Consumes the builder and constructs a [`TaskSuiteSnapshotDataset`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](TaskSuiteSnapshotDatasetBuilder::id)
    /// - [`name`](TaskSuiteSnapshotDatasetBuilder::name)
    /// - [`trace_count`](TaskSuiteSnapshotDatasetBuilder::trace_count)
    pub fn build(self) -> Result<TaskSuiteSnapshotDataset, BuildError> {
        Ok(TaskSuiteSnapshotDataset {
