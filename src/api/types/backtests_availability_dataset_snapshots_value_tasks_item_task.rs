...
pub struct BacktestsAvailabilityDatasetSnapshotsValueTasksItemTask {
    ...
    pub config: Option<BacktestsAvailabilityDatasetSnapshotsValueTasksItemTaskConfig>,
...
impl BacktestsAvailabilityDatasetSnapshotsValueTasksItemTask {
    pub fn builder() -> BacktestsAvailabilityDatasetSnapshotsValueTasksItemTaskBuilder {
        <BacktestsAvailabilityDatasetSnapshotsValueTasksItemTaskBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BacktestsAvailabilityDatasetSnapshotsValueTasksItemTaskBuilder {
    config: Option<BacktestsAvailabilityDatasetSnapshotsValueTasksItemTaskConfig>,
...
impl BacktestsAvailabilityDatasetSnapshotsValueTasksItemTaskBuilder {
    pub fn config(
        mut self,
        value: BacktestsAvailabilityDatasetSnapshotsValueTasksItemTaskConfig,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`BacktestsAvailabilityDatasetSnapshotsValueTasksItemTask`].
    pub fn build(
        self,
    ) -> Result<BacktestsAvailabilityDatasetSnapshotsValueTasksItemTask, BuildError> {
        Ok(BacktestsAvailabilityDatasetSnapshotsValueTasksItemTask {
            config: self.config,
