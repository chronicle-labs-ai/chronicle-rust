...
pub struct AgentSummary {
    ...
    pub framework: AgentSummaryFramework,
...
impl AgentSummary {
    pub fn builder() -> AgentSummaryBuilder {
        <AgentSummaryBuilder as Default>::default()
    }
}
...
impl AgentSummaryBuilder {
    ...
    pub fn framework(mut self, value: AgentSummaryFramework) -> Self {
    ...
    pub fn model(mut self, value: AgentSummaryModel) -> Self {
    ...
    /// Consumes the builder and constructs a [`AgentSummary`].
    /// This method will fail if any of the following fields are not set:
    /// - [`framework`](AgentSummaryBuilder::framework)
    /// - [`latest_version`](AgentSummaryBuilder::latest_version)
    /// - [`model`](AgentSummaryBuilder::model)
    /// - [`model_label`](AgentSummaryBuilder::model_label)
    /// - [`name`](AgentSummaryBuilder::name)
    /// - [`success_rate`](AgentSummaryBuilder::success_rate)
    /// - [`total_runs`](AgentSummaryBuilder::total_runs)
    /// - [`version_count`](AgentSummaryBuilder::version_count)
    pub fn build(self) -> Result<AgentSummary, BuildError> {
        Ok(AgentSummary {
