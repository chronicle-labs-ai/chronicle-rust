...
pub enum RegisterAgentArtifactRequestArtifactFramework {
    VercelAiSdk,
    OpenaiAgents,
    Langchain,
    Mastra,
...
impl Serialize for RegisterAgentArtifactRequestArtifactFramework {
...
impl<'de> Deserialize<'de> for RegisterAgentArtifactRequestArtifactFramework {
...
impl fmt::Display for RegisterAgentArtifactRequestArtifactFramework {
