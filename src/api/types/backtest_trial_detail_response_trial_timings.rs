...
pub struct BacktestTrialDetailResponseTrialTimings {
...
impl BacktestTrialDetailResponseTrialTimings {
    pub fn builder() -> BacktestTrialDetailResponseTrialTimingsBuilder {
        <BacktestTrialDetailResponseTrialTimingsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BacktestTrialDetailResponseTrialTimingsBuilder {
...
impl BacktestTrialDetailResponseTrialTimingsBuilder {
    ...
    /// Consumes the builder and constructs a [`BacktestTrialDetailResponseTrialTimings`].
    pub fn build(self) -> Result<BacktestTrialDetailResponseTrialTimings, BuildError> {
        Ok(BacktestTrialDetailResponseTrialTimings {
