...
pub enum TrialEventJobFinishedStatus {
    Pending,
    Running,
    Succeeded,
    Failed,
...
impl Serialize for TrialEventJobFinishedStatus {
...
impl<'de> Deserialize<'de> for TrialEventJobFinishedStatus {
...
impl fmt::Display for TrialEventJobFinishedStatus {
