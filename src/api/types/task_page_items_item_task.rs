...
pub struct TaskPageItemsItemTask {
    ...
    pub config: Option<TaskPageItemsItemTaskConfig>,
...
impl TaskPageItemsItemTask {
    pub fn builder() -> TaskPageItemsItemTaskBuilder {
        <TaskPageItemsItemTaskBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TaskPageItemsItemTaskBuilder {
    config: Option<TaskPageItemsItemTaskConfig>,
...
impl TaskPageItemsItemTaskBuilder {
    pub fn config(mut self, value: TaskPageItemsItemTaskConfig) -> Self {
    ...
    /// Consumes the builder and constructs a [`TaskPageItemsItemTask`].
    pub fn build(self) -> Result<TaskPageItemsItemTask, BuildError> {
        Ok(TaskPageItemsItemTask {
            config: self.config,
