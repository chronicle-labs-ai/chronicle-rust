...
pub enum CancelBacktestJobResponsePreviousStatus {
    Pending,
    Running,
    Succeeded,
    Failed,
...
impl Serialize for CancelBacktestJobResponsePreviousStatus {
...
impl<'de> Deserialize<'de> for CancelBacktestJobResponsePreviousStatus {
...
impl fmt::Display for CancelBacktestJobResponsePreviousStatus {
