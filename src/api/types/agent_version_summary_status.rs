...
pub enum AgentVersionSummaryStatus {
    Current,
    Stable,
    Deprecated,
    Draft,
...
impl Serialize for AgentVersionSummaryStatus {
...
impl<'de> Deserialize<'de> for AgentVersionSummaryStatus {
...
impl fmt::Display for AgentVersionSummaryStatus {
