...
pub struct BacktestTrialDetailResponseTrial {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub exception: Option<BacktestTrialDetailResponseTrialException>,
    #[serde(default)]
    pub id: String,
...
impl BacktestTrialDetailResponseTrial {
    pub fn builder() -> BacktestTrialDetailResponseTrialBuilder {
        <BacktestTrialDetailResponseTrialBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BacktestTrialDetailResponseTrialBuilder {
    ...
    exception: Option<BacktestTrialDetailResponseTrialException>,
    id: Option<String>,
    instruction: Option<String>,
    is_baseline: Option<bool>,
    job_id: Option<String>,
    sandbox_id: Option<String>,
    status: Option<BacktestTrialDetailResponseTrialStatus>,
    tenant_id: Option<String>,
    timings: Option<BacktestTrialDetailResponseTrialTimings>,
    updated_at: Option<DateTime<FixedOffset>>,
}

impl BacktestTrialDetailResponseTrialBuilder {
    ...
    pub fn exception(mut self, value: BacktestTrialDetailResponseTrialException) -> Self {
    ...
    pub fn status(mut self, value: BacktestTrialDetailResponseTrialStatus) -> Self {
    ...
    pub fn timings(mut self, value: BacktestTrialDetailResponseTrialTimings) -> Self {
    ...
    /// Consumes the builder and constructs a [`BacktestTrialDetailResponseTrial`].
    /// This method will fail if any of the following fields are not set:
    /// - [`agent_id`](BacktestTrialDetailResponseTrialBuilder::agent_id)
    /// - [`agent_label`](BacktestTrialDetailResponseTrialBuilder::agent_label)
    /// - [`attempt`](BacktestTrialDetailResponseTrialBuilder::attempt)
    /// - [`case_id`](BacktestTrialDetailResponseTrialBuilder::case_id)
    /// - [`created_at`](BacktestTrialDetailResponseTrialBuilder::created_at)
    /// - [`id`](BacktestTrialDetailResponseTrialBuilder::id)
    /// - [`is_baseline`](BacktestTrialDetailResponseTrialBuilder::is_baseline)
    /// - [`job_id`](BacktestTrialDetailResponseTrialBuilder::job_id)
    /// - [`status`](BacktestTrialDetailResponseTrialBuilder::status)
    /// - [`tenant_id`](BacktestTrialDetailResponseTrialBuilder::tenant_id)
    /// - [`timings`](BacktestTrialDetailResponseTrialBuilder::timings)
    /// - [`updated_at`](BacktestTrialDetailResponseTrialBuilder::updated_at)
    pub fn build(self) -> Result<BacktestTrialDetailResponseTrial, BuildError> {
        Ok(BacktestTrialDetailResponseTrial {
            agent_id: self
                .agent_id
