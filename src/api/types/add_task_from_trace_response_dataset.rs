...
pub struct AddTaskFromTraceResponseDataset {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub purpose: Option<AddTaskFromTraceResponseDatasetPurpose>,
...
impl AddTaskFromTraceResponseDataset {
    pub fn builder() -> AddTaskFromTraceResponseDatasetBuilder {
        <AddTaskFromTraceResponseDatasetBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AddTaskFromTraceResponseDatasetBuilder {
    ...
    id: Option<String>,
    name: Option<String>,
    purpose: Option<AddTaskFromTraceResponseDatasetPurpose>,
    tags: Option<Vec<String>>,
    trace_count: Option<i64>,
    updated_at: Option<DateTime<FixedOffset>>,
}

impl AddTaskFromTraceResponseDatasetBuilder {
    ...
    pub fn purpose(mut self, value: AddTaskFromTraceResponseDatasetPurpose) -> Self {
    ...
    /// Consumes the builder and constructs a [`AddTaskFromTraceResponseDataset`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](AddTaskFromTraceResponseDatasetBuilder::id)
    /// - [`name`](AddTaskFromTraceResponseDatasetBuilder::name)
    /// - [`trace_count`](AddTaskFromTraceResponseDatasetBuilder::trace_count)
    pub fn build(self) -> Result<AddTaskFromTraceResponseDataset, BuildError> {
        Ok(AddTaskFromTraceResponseDataset {
