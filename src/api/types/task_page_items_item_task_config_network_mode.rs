...
pub enum TaskPageItemsItemTaskConfigNetworkMode {
    Public,
    NoNetwork,
...
impl Serialize for TaskPageItemsItemTaskConfigNetworkMode {
...
impl<'de> Deserialize<'de> for TaskPageItemsItemTaskConfigNetworkMode {
...
impl fmt::Display for TaskPageItemsItemTaskConfigNetworkMode {
