...
pub struct BacktestJobDetailResponseRun {
    ...
    #[serde(default)]
    pub id: String,
    pub mode: BacktestJobDetailResponseRunMode,
    ...
    pub status: BacktestJobDetailResponseRunStatus,
...
impl BacktestJobDetailResponseRun {
    pub fn builder() -> BacktestJobDetailResponseRunBuilder {
        <BacktestJobDetailResponseRunBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BacktestJobDetailResponseRunBuilder {
    ...
    hue: Option<String>,
    id: Option<String>,
    mode: Option<BacktestJobDetailResponseRunMode>,
    name: Option<String>,
    owner: Option<String>,
    scheduled_for: Option<DateTime<FixedOffset>>,
    status: Option<BacktestJobDetailResponseRunStatus>,
    total_runs: Option<i64>,
    updated_at: Option<DateTime<FixedOffset>>,
    verdict: Option<String>,
}

impl BacktestJobDetailResponseRunBuilder {
    ...
    pub fn mode(mut self, value: BacktestJobDetailResponseRunMode) -> Self {
    ...
    pub fn status(mut self, value: BacktestJobDetailResponseRunStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`BacktestJobDetailResponseRun`].
    /// This method will fail if any of the following fields are not set:
    /// - [`agent_ids`](BacktestJobDetailResponseRunBuilder::agent_ids)
    /// - [`dataset_label`](BacktestJobDetailResponseRunBuilder::dataset_label)
    /// - [`id`](BacktestJobDetailResponseRunBuilder::id)
    /// - [`mode`](BacktestJobDetailResponseRunBuilder::mode)
    /// - [`name`](BacktestJobDetailResponseRunBuilder::name)
    /// - [`status`](BacktestJobDetailResponseRunBuilder::status)
    /// - [`updated_at`](BacktestJobDetailResponseRunBuilder::updated_at)
    pub fn build(self) -> Result<BacktestJobDetailResponseRun, BuildError> {
        Ok(BacktestJobDetailResponseRun {
            agent_ids: self
                .agent_ids
