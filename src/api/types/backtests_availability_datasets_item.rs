...
pub struct BacktestsAvailabilityDatasetsItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub purpose: Option<BacktestsAvailabilityDatasetsItemPurpose>,
...
impl BacktestsAvailabilityDatasetsItem {
    pub fn builder() -> BacktestsAvailabilityDatasetsItemBuilder {
        <BacktestsAvailabilityDatasetsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BacktestsAvailabilityDatasetsItemBuilder {
    ...
    id: Option<String>,
    name: Option<String>,
    purpose: Option<BacktestsAvailabilityDatasetsItemPurpose>,
    tags: Option<Vec<String>>,
    trace_count: Option<i64>,
    updated_at: Option<DateTime<FixedOffset>>,
}

impl BacktestsAvailabilityDatasetsItemBuilder {
    ...
    pub fn purpose(mut self, value: BacktestsAvailabilityDatasetsItemPurpose) -> Self {
    ...
    /// Consumes the builder and constructs a [`BacktestsAvailabilityDatasetsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](BacktestsAvailabilityDatasetsItemBuilder::id)
    /// - [`name`](BacktestsAvailabilityDatasetsItemBuilder::name)
    /// - [`trace_count`](BacktestsAvailabilityDatasetsItemBuilder::trace_count)
    pub fn build(self) -> Result<BacktestsAvailabilityDatasetsItem, BuildError> {
        Ok(BacktestsAvailabilityDatasetsItem {
