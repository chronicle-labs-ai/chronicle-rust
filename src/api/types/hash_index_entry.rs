...
pub struct HashIndexEntry {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub framework: Option<HashIndexEntryFramework>,
    #[serde(default)]
    pub hash: String,
...
impl HashIndexEntry {
    pub fn builder() -> HashIndexEntryBuilder {
        <HashIndexEntryBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct HashIndexEntryBuilder {
    agent_name: Option<String>,
    artifact_id: Option<String>,
    framework: Option<HashIndexEntryFramework>,
    hash: Option<String>,
    kind: Option<HashIndexEntryKind>,
...
impl HashIndexEntryBuilder {
    ...
    pub fn framework(mut self, value: HashIndexEntryFramework) -> Self {
    ...
    pub fn kind(mut self, value: HashIndexEntryKind) -> Self {
    ...
    /// Consumes the builder and constructs a [`HashIndexEntry`].
    /// This method will fail if any of the following fields are not set:
    /// - [`hash`](HashIndexEntryBuilder::hash)
    /// - [`kind`](HashIndexEntryBuilder::kind)
    /// - [`observed_at`](HashIndexEntryBuilder::observed_at)
    /// - [`path`](HashIndexEntryBuilder::path)
    pub fn build(self) -> Result<HashIndexEntry, BuildError> {
        Ok(HashIndexEntry {
