...
pub enum TaskPageItemsItemVerifiersItemWeight {
    Low,
    Med,
    High,
...
impl Serialize for TaskPageItemsItemVerifiersItemWeight {
...
impl<'de> Deserialize<'de> for TaskPageItemsItemVerifiersItemWeight {
...
impl fmt::Display for TaskPageItemsItemVerifiersItemWeight {
