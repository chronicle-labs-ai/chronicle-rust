...
pub struct AddTaskFromTraceRequestTask {
    ...
    pub config: Option<AddTaskFromTraceRequestTaskConfig>,
...
impl AddTaskFromTraceRequestTask {
    pub fn builder() -> AddTaskFromTraceRequestTaskBuilder {
        <AddTaskFromTraceRequestTaskBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AddTaskFromTraceRequestTaskBuilder {
    config: Option<AddTaskFromTraceRequestTaskConfig>,
...
impl AddTaskFromTraceRequestTaskBuilder {
    pub fn config(mut self, value: AddTaskFromTraceRequestTaskConfig) -> Self {
    ...
    /// Consumes the builder and constructs a [`AddTaskFromTraceRequestTask`].
    pub fn build(self) -> Result<AddTaskFromTraceRequestTask, BuildError> {
        Ok(AddTaskFromTraceRequestTask {
            config: self.config,
