...
pub struct CreateSavedViewRequestState {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub filters: Option<Vec<CreateSavedViewRequestStateFiltersItem>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sorting: Option<Vec<CreateSavedViewRequestStateSortingItem>>,
}

impl CreateSavedViewRequestState {
    pub fn builder() -> CreateSavedViewRequestStateBuilder {
        <CreateSavedViewRequestStateBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateSavedViewRequestStateBuilder {
    density: Option<String>,
    display_properties: Option<Vec<String>>,
    filters: Option<Vec<CreateSavedViewRequestStateFiltersItem>>,
    group_by: Option<String>,
    lens: Option<String>,
    ordering: Option<String>,
    search: Option<String>,
    show_empty_groups: Option<bool>,
    sorting: Option<Vec<CreateSavedViewRequestStateSortingItem>>,
}

impl CreateSavedViewRequestStateBuilder {
    ...
    pub fn filters(mut self, value: Vec<CreateSavedViewRequestStateFiltersItem>) -> Self {
    ...
    pub fn sorting(mut self, value: Vec<CreateSavedViewRequestStateSortingItem>) -> Self {
        self.sorting = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`CreateSavedViewRequestState`].
    pub fn build(self) -> Result<CreateSavedViewRequestState, BuildError> {
        Ok(CreateSavedViewRequestState {
