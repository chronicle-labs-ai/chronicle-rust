...
pub enum AgentSummaryFramework {
    VercelAiSdk,
    OpenaiAgents,
    Langchain,
    Mastra,
...
impl Serialize for AgentSummaryFramework {
...
impl<'de> Deserialize<'de> for AgentSummaryFramework {
...
impl fmt::Display for AgentSummaryFramework {
