...
pub struct AgentVersionSummaryArtifactProvenance {
...
impl AgentVersionSummaryArtifactProvenance {
    pub fn builder() -> AgentVersionSummaryArtifactProvenanceBuilder {
        <AgentVersionSummaryArtifactProvenanceBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AgentVersionSummaryArtifactProvenanceBuilder {
...
impl AgentVersionSummaryArtifactProvenanceBuilder {
    ...
    /// Consumes the builder and constructs a [`AgentVersionSummaryArtifactProvenance`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](AgentVersionSummaryArtifactProvenanceBuilder::created_at)
    pub fn build(self) -> Result<AgentVersionSummaryArtifactProvenance, BuildError> {
        Ok(AgentVersionSummaryArtifactProvenance {
