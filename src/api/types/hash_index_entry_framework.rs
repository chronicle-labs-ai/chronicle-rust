...
pub enum HashIndexEntryFramework {
    VercelAiSdk,
    OpenaiAgents,
    Langchain,
    Mastra,
...
impl Serialize for HashIndexEntryFramework {
...
impl<'de> Deserialize<'de> for HashIndexEntryFramework {
...
impl fmt::Display for HashIndexEntryFramework {
