...
pub enum AgentSnapshotVersionsItemArtifactFramework {
    VercelAiSdk,
    OpenaiAgents,
    Langchain,
    Mastra,
...
impl Serialize for AgentSnapshotVersionsItemArtifactFramework {
...
impl<'de> Deserialize<'de> for AgentSnapshotVersionsItemArtifactFramework {
...
impl fmt::Display for AgentSnapshotVersionsItemArtifactFramework {
