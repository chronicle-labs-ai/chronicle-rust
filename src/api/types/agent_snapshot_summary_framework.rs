...
pub enum AgentSnapshotSummaryFramework {
    VercelAiSdk,
    OpenaiAgents,
    Langchain,
    Mastra,
...
impl Serialize for AgentSnapshotSummaryFramework {
...
impl<'de> Deserialize<'de> for AgentSnapshotSummaryFramework {
...
impl fmt::Display for AgentSnapshotSummaryFramework {
