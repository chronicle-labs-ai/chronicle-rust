...
pub enum CreateBacktestJobRequestRecipeMode {
    Replay,
    Compare,
    Regression,
    Suite,
...
impl Serialize for CreateBacktestJobRequestRecipeMode {
...
impl<'de> Deserialize<'de> for CreateBacktestJobRequestRecipeMode {
...
impl fmt::Display for CreateBacktestJobRequestRecipeMode {
