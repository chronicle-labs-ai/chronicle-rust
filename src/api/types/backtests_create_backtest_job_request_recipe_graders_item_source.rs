...
pub enum CreateBacktestJobRequestRecipeGradersItemSource {
    Proposed,
    Library,
    Custom,
    Dataset,
...
impl Serialize for CreateBacktestJobRequestRecipeGradersItemSource {
...
impl<'de> Deserialize<'de> for CreateBacktestJobRequestRecipeGradersItemSource {
...
impl fmt::Display for CreateBacktestJobRequestRecipeGradersItemSource {
