...
pub struct BacktestsAvailabilityAgentsItem {
    ...
    pub framework: BacktestsAvailabilityAgentsItemFramework,
    ...
    #[serde(default)]
    pub model: BacktestsAvailabilityAgentsItemModel,
...
impl BacktestsAvailabilityAgentsItem {
    pub fn builder() -> BacktestsAvailabilityAgentsItemBuilder {
        <BacktestsAvailabilityAgentsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BacktestsAvailabilityAgentsItemBuilder {
    capability_tags: Option<Vec<String>>,
    category: Option<String>,
    description: Option<String>,
    environment: Option<String>,
    framework: Option<BacktestsAvailabilityAgentsItemFramework>,
    last_drift_at: Option<DateTime<FixedOffset>>,
    last_run_at: Option<DateTime<FixedOffset>>,
    latest_version: Option<String>,
    model: Option<BacktestsAvailabilityAgentsItemModel>,
...
impl BacktestsAvailabilityAgentsItemBuilder {
    ...
    pub fn framework(mut self, value: BacktestsAvailabilityAgentsItemFramework) -> Self {
    ...
    pub fn model(mut self, value: BacktestsAvailabilityAgentsItemModel) -> Self {
    ...
    /// Consumes the builder and constructs a [`BacktestsAvailabilityAgentsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`framework`](BacktestsAvailabilityAgentsItemBuilder::framework)
    /// - [`latest_version`](BacktestsAvailabilityAgentsItemBuilder::latest_version)
    /// - [`model`](BacktestsAvailabilityAgentsItemBuilder::model)
    /// - [`model_label`](BacktestsAvailabilityAgentsItemBuilder::model_label)
    /// - [`name`](BacktestsAvailabilityAgentsItemBuilder::name)
    /// - [`success_rate`](BacktestsAvailabilityAgentsItemBuilder::success_rate)
    /// - [`total_runs`](BacktestsAvailabilityAgentsItemBuilder::total_runs)
    /// - [`version_count`](BacktestsAvailabilityAgentsItemBuilder::version_count)
    pub fn build(self) -> Result<BacktestsAvailabilityAgentsItem, BuildError> {
        Ok(BacktestsAvailabilityAgentsItem {
