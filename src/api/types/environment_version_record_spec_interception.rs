...
pub struct EnvironmentVersionRecordSpecInterception {
...
impl EnvironmentVersionRecordSpecInterception {
    pub fn builder() -> EnvironmentVersionRecordSpecInterceptionBuilder {
        <EnvironmentVersionRecordSpecInterceptionBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct EnvironmentVersionRecordSpecInterceptionBuilder {
    install_ca: Option<bool>,
    regular_proxy_port: Option<i64>,
    transparent_proxy_port: Option<i64>,
}

impl EnvironmentVersionRecordSpecInterceptionBuilder {
    ...
    /// Consumes the builder and constructs a [`EnvironmentVersionRecordSpecInterception`].
    pub fn build(self) -> Result<EnvironmentVersionRecordSpecInterception, BuildError> {
        Ok(EnvironmentVersionRecordSpecInterception {
