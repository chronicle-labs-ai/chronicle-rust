...
pub enum CreateTaskSuiteWithTraceResponseMembershipSubjectKind {
    Trace,
    Event,
    Task,
...
impl Serialize for CreateTaskSuiteWithTraceResponseMembershipSubjectKind {
...
impl<'de> Deserialize<'de> for CreateTaskSuiteWithTraceResponseMembershipSubjectKind {
...
impl fmt::Display for CreateTaskSuiteWithTraceResponseMembershipSubjectKind {
