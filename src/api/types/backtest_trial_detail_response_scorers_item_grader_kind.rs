...
pub enum BacktestTrialDetailResponseScorersItemGraderKind {
    Rubric,
    Classifier,
    Metric,
    Embedding,
...
impl Serialize for BacktestTrialDetailResponseScorersItemGraderKind {
...
impl<'de> Deserialize<'de> for BacktestTrialDetailResponseScorersItemGraderKind {
...
impl fmt::Display for BacktestTrialDetailResponseScorersItemGraderKind {
