...
pub enum TaskPageItemsItemStatus {
    Ok,
    Warn,
    Error,
...
impl Serialize for TaskPageItemsItemStatus {
...
impl<'de> Deserialize<'de> for TaskPageItemsItemStatus {
...
impl fmt::Display for TaskPageItemsItemStatus {
