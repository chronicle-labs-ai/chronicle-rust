...
pub struct CreateTaskSuiteWithTraceResponseDataset {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub purpose: Option<CreateTaskSuiteWithTraceResponseDatasetPurpose>,
...
impl CreateTaskSuiteWithTraceResponseDataset {
    pub fn builder() -> CreateTaskSuiteWithTraceResponseDatasetBuilder {
        <CreateTaskSuiteWithTraceResponseDatasetBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateTaskSuiteWithTraceResponseDatasetBuilder {
    ...
    id: Option<String>,
    name: Option<String>,
    purpose: Option<CreateTaskSuiteWithTraceResponseDatasetPurpose>,
    tags: Option<Vec<String>>,
    trace_count: Option<i64>,
    updated_at: Option<DateTime<FixedOffset>>,
}

impl CreateTaskSuiteWithTraceResponseDatasetBuilder {
    ...
    pub fn purpose(mut self, value: CreateTaskSuiteWithTraceResponseDatasetPurpose) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateTaskSuiteWithTraceResponseDataset`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](CreateTaskSuiteWithTraceResponseDatasetBuilder::id)
    /// - [`name`](CreateTaskSuiteWithTraceResponseDatasetBuilder::name)
    /// - [`trace_count`](CreateTaskSuiteWithTraceResponseDatasetBuilder::trace_count)
    pub fn build(self) -> Result<CreateTaskSuiteWithTraceResponseDataset, BuildError> {
        Ok(CreateTaskSuiteWithTraceResponseDataset {
